...
<template>
    <section class="p-4 bg-gray-100 rounded-lg shadow-md text-center">
        ...
        <button @click="handleLeave" class="bg-red-500 text-white font-semibold py-2 px-4 mb-4 w-full rounded hover:bg-red-600 transition duration-200">Leave</button>
        <div class="space-y-2">
