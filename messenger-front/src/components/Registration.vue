...
<template>
  ...
  <div class="max-w-md mx-auto p-4 pt-6 md:p-6 md:pt-0">
    <form @submit.prevent="handleRegistration" class="bg-white shadow-md rounded-2xl px-8 pt-6 pb-8 mb-4">
      ...
      <div class="mb-4">
        ...
        <input type="password" v-model="form.passwordConfirm" name="passwordConfirm" id="passwordConfirm" placeholder="" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" />
      </div>
      <div class="mb-4">
        <label class="block text-gray-700" for="username">Username</label>
        <input type="text" v-model="form.username" name="username" id="username" placeholder="" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" />
      </div>
      <div class="flex items-center justify-between">
        <button class="bg-emerald-600 hover:bg-emerald-800 text-white font-bold py-2 w-full rounded" type="submit">Register</button>
      </div>
